package com.massimiliano.webapp.UnitTest;
...
import com.massimiliano.webapp.GetuserWebServiceStartApplication;
...
@ContextConfiguration(classes = GetuserWebServiceStartApplication.class)
@SpringBootTest
...
public class UtentiControllerTest
{
    ...
    {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/utenti/cerca/userid/Massimiliano")
                .accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.userId").value("Massimiliano"))
        ...
        assertThat(passwordEncoder.matches("123Stella",
                utentiRepository.findByUserId("Massimiliano").getPassword()))
                .isEqualTo(true);
    }
    ...
    public void D_testGetAllUser() throws Exception
    {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/utenti/cerca/tutti")
                ...
                .andExpect(jsonPath("$[0].userId").value("Massimiliano"))
    ...
    {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/utenti/elimina/Massimiliano")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value("200 OK"))
                .andExpect(jsonPath("$.message").value("Eliminazione Utente Massimiliano Eseguita Con Successo"))
                .andDo(print());
    }
