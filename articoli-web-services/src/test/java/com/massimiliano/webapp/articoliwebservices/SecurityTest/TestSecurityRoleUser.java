package com.massimiliano.webapp.articoliwebservices.SecurityTest;
...
import com.massimiliano.webapp.utility.JsonData;
...
public class TestSecurityRoleUser {
    ...
    public void setup() {
        this.mockMvc = MockMvcBuilders
                ...
                .defaultRequest(get("/")
                        .with(user("Massimiliano").roles("USER"))) //Attivato Ruolo User
