package com.massimiliano.webapp.controllerTest;
...
import com.massimiliano.webapp.PriceartWebServiceStartApplication;
...
@ContextConfiguration(classes = PriceartWebServiceStartApplication.class)
@SpringBootTest
